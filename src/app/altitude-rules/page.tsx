...
const ITEMS = [
  ...
  {
    title: "2. לא לעלות את גובה השינה ביותר מ־500 מ׳ ביום",
  ...
  {
    title: "4. כאב ראש, בחילה, סחרחורת ותשישות הם תסמינים של מחלת גבהים",
    body: "תסמינים אלו יכולים להופיע כחלק ממחלת גבהים, במיוחד לאחר עלייה בגובה או שינה בגובה גבוה יותר.",
  },
  {
  ...
  },
  {
    ...
    body: "מעל גובה 2500 מטר הסיכון למחלת גבהים עולה, במיוחד כאשר קצב העלייה מהיר או כאשר עולים מהר בגובה השינה.",
  },
];
